            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Kitob qo'shish - yangilash</h5>
                        <small class="text-muted float-end">* - majburiy to'ldirish maydonlari</small>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row mb-3">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary bg-indigo-500">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
